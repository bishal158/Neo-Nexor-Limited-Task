...
export default function LocationMap() {
  ...
  return (
    <div className="bg-surface rounded-[4px] border border-line overflow-hidden">
      <div className="p-3.5 sm:p-8 flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 border-b border-line">
        <div>
          ...
          <h3 className="font-display text-lg sm:text-xl text-ink font-normal">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 text-xs font-medium px-3.5 py-1.5 sm:px-4 sm:py-2 bg-sand border border-line rounded-[4px] text-ink hover:text-accent hover:border-accent transition-colors self-start sm:self-auto shrink-0"
        >
      ...
      {/* Map Embed Container */}
      <div className="relative aspect-[16/10] sm:aspect-[21/9] w-full bg-sand overflow-hidden">
        <iframe
