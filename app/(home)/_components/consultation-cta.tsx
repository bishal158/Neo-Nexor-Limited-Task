    ...
    <section className="bg-accent-deep text-base py-20 md:py-24 relative overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center space-y-6">
          ...
          <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl text-base font-light leading-tight">
            Ready to shape an interior of quiet elegance?
          </h2>

          <p className="text-base/80 text-sm sm:text-base leading-relaxed max-w-[60ch] mx-auto">
          ...
          <div className="pt-4 flex flex-wrap items-center justify-center gap-4">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 text-sm text-base hover:text-highlight transition-colors px-4 py-3"
            >
          ...
          <p className="text-xs text-base/60 pt-4">
