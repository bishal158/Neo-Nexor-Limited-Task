...
export default function HeroSection() {
  return (
    <section className="relative overflow-hidden pt-8 pb-12 sm:pt-12 sm:pb-16 md:pt-20 md:pb-28 bg-sand">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-4 sm:space-y-6">
            ...
            <h1 className="font-display text-2xl sm:text-5xl lg:text-6xl text-ink font-light leading-[1.08] tracking-tight">
            ...
            <p className="text-ink-muted text-sm sm:text-base leading-relaxed max-w-[58ch]">
            ...
            {/* Key Metrics */}
            <div className="grid grid-cols-3 gap-2 sm:gap-4 pt-4 sm:pt-8 border-t border-line max-w-lg">
              <div>
                <span className="block font-display text-lg sm:text-3xl text-ink font-normal">
                  140+
                </span>
                <span className="text-[10px] sm:text-xs text-ink-muted">Completed Spaces</span>
              </div>
              <div>
                <span className="block font-display text-lg sm:text-3xl text-ink font-normal">
                  14 yrs
                </span>
                <span className="text-[10px] sm:text-xs text-ink-muted">Design Mastery</span>
              </div>
              <div>
                <span className="block font-display text-lg sm:text-3xl text-ink font-normal">
                  100%
                </span>
                <span className="text-[10px] sm:text-xs text-ink-muted">Turnkey Execution</span>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative aspect-[4/3] sm:aspect-[4/5] rounded-[4px] overflow-hidden border border-line bg-surface">
              <Image
